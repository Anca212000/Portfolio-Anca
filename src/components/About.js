          ...
          <Grid item xs={12} sm={12} md={12} lg={6}>
            ...
            >
              <div>
                ...
                knowledge about both fields, frontend and backend. I like
                working with both tehnologies (frontend and backend), but
                especially in the frontend field, because I can share my
                creativity, combined with the UI design in creating web
                applications - I would like to share my ideas, creativity and
                originality in creating apps. I have a passion to be up to date
                with latest releases about web technologies and learning new
                informations.
                <br />
                <br />
                {/* &emsp;
